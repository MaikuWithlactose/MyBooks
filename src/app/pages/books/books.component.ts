...
export class BooksComponent {
  books: Books[] = [
    ...
    new Books('El caso de Charles Dexter Ward', 'Horror', 'H.P. Lovecraft', 11.99, 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1650342685i/30308694.jpg', 6, 4),
